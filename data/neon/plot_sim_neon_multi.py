...
# ==========================================
# Graphe 1 : sim_neon_multi1 vs sim_neon_multi2 (Hard vs Soft)
# ==========================================
...
df1 = charger_csv("sim_neon_multi1.csv")
df2 = charger_csv("sim_neon_multi2.csv")
...
if df1 is not None and not df1.empty:
    plt.plot(
        ...
        linestyle="-",
        color="tab:green",
        label="FER sim_neon_multi1 (Hard)",
    )
    plt.plot(
        df1["snr_bit"],
        df1["ber"],
        ...
        color="tab:green",
        fillstyle="none",
        label="BER sim_neon_multi1 (Hard)",
    )
if df2 is not None and not df2.empty:
    plt.plot(
        ...
        linestyle="-",
        color="tab:blue",
        label="FER sim_neon_multi2 (Soft)",
    )
    plt.plot(
        df2["snr_bit"],
        df2["ber"],
        ...
        color="tab:blue",
        fillstyle="none",
        label="BER sim_neon_multi2 (Soft)",
    )
...
# ==========================================
# Graphe 2 : sim_neon_multi2 à sim_neon_multi5 (Différents Code Rates en fonction de snr_bit)
# ==========================================
plt.figure(figsize=(10, 6))
plt.yscale("log")
plt.grid(True, which="both", ls="--", alpha=0.5)
...
simulations = [
    ("sim_neon_multi2.csv", "R=1/4", "tab:blue"),
    ("sim_neon_multi3.csv", "R=1/3", "tab:red"),
    ("sim_neon_multi4.csv", "R=1/2", "tab:orange"),
    ("sim_neon_multi5.csv", "R=1 (Uncoded)", "tab:purple"),
]
...
# ==========================================
# Graphe 3 : sim_neon_multi2 à sim_neon_multi5 (Différents Code Rates en fonction de snr_symbol)
# ==========================================
plt.figure(figsize=(10, 6))
plt.yscale("log")
plt.grid(True, which="both", ls="--", alpha=0.5)
