...
for f in $(seq 0 8); do
  ...
  for s in $(seq 1 8); do
    ...
    if [ $s -gt $f ]; then
      ...
      ./build/bin/simulator -m 0 -M $MAX_SNR_SIM1 -s 1 -e 100 -K 32 -N 128 -D "rep-hard" --qf $f --qs $s
      ...
      ./build/bin/simulator -m 0 -M $MAX_SNR_OTHERS -s 1 -e 100 -K 32 -N 128 -D "rep-soft" --qf $f --qs $s
      ...
      ./build/bin/simulator -m 0 -M $MAX_SNR_OTHERS -s 1 -e 100 -K 32 -N 96 -D "rep-soft" --qf $f --qs $s
      ...
      ./build/bin/simulator -m 0 -M $MAX_SNR_OTHERS -s 1 -e 100 -K 32 -N 64 -D "rep-soft" --qf $f --qs $s
      ...
      ./build/bin/simulator -m 0 -M $MAX_SNR_OTHERS -s 1 -e 100 -K 32 -N 32 -D "rep-soft" --qf $f --qs $s
